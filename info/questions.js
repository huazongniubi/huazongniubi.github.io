questions = [
    ...
    {
        "id": "calcul_6",
        "question": "公式：华总牛逼与牛逼华总的平方和 × 华总华总与牛逼牛逼的平方和 ≥ (华总牛逼×华总华总 + 牛逼华总×牛逼牛逼) 的平方，最早是由法国数学家提出，并且当且仅当 华总=牛逼 时取等号",
        "effect": {
            "calcul": 10
        }
    },
    ...
    {
        "id": "history_2",
        "question": "华总的热爱读书、擅长商业、痴迷研究等优点，主要来自于宁波籍著名人物：方孝孺、邵逸夫、李达三、黄昊、童第周、谈家桢、屠呦呦等人的影响",
        "effect": {
            "history": -10
        }
    },
